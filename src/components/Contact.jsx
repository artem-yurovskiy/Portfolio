...
function Contact() {
  return (
    <section
      id="contact"
      className="bg-[var(--navy-mid)] px-[clamp(1.5rem,6vw,5rem)] py-[clamp(2.5rem,6vw,4rem)] scroll-mt-[var(--nav-height)]"
    >
      <div className="mx-auto flex max-w-[1360px] flex-col gap-6 sm:gap-7">
        ...
        <p className="text-base text-[var(--body-slate)] sm:text-lg">Let&rsquo;s connect.</p>
        ...
        <div className="flex flex-wrap gap-3">
          {CONTACT_LINKS.map(({ label, href, Icon, external }) => (
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/15 px-5 py-2.5 text-sm font-medium text-[var(--name-warm-white)] transition-colors hover:border-white/35"
            >
